 ...
 * @author Rodrigo
 */
public class VentanaAgregarMaterial extends javax.swing.JFrame {
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        ...
        try {
            ...
            while (validador == true) {
                ...
                if (rb_documental.isSelected()==false && rb_pelicula.isSelected()==false) {
                    JOptionPane.showMessageDialog(rootPane, "DEBE SELECCIONAR UN FORMATO");
                    break;
                }
                if (sp_duracion.getValue().equals(0)) {
                    JOptionPane.showMessageDialog(rootPane, "DEBE INGRESAR DURACIÓN");
                    break;
                }
                ...
                if (txt_autor.getText().equals("")) {
                    JOptionPane.showMessageDialog(rootPane, "DEBE INGRESAR UN AUTOR");
                    break;
                }
                validador = false;
            }
            ...
            if (!validador) {
                ...
                ctrlMaterial.materialAlmacenar(material);
            
                JOptionPane.showMessageDialog(rootPane, "MATERIAL ALMACENADO CORRECTAMENTE");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaAgregarMaterial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
